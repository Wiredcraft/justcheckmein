...
exports.code128 = function (ctx, text, width, height) {
  ...
  var codes = cardIdToCode128(text);
...
function cardIdToCode128(text) {
  var barc = {
    currcs: CODESET.C
  };
  var bytes = getBytes(text);
  // start, C, numbers, B, number, checksum, stop
  var codes = new Array();
  ...
  function codesForChar(b1, b2, currcs) {
    if (b2 === -1) {
      return [SET_CODEB, codeValue(b1)]
    }else {
      return [codeValue(b1, b2)]
    }
  }
